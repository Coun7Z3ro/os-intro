...
Напишем код первой программы в файле script1.sh (рис. [-@fig:001]).

![Код первой программы](image/1.png){#fig:001}

Напишем код второй программы на С в файле code.c (рис. [-@fig:002]).

![Код второй программы на С](image/2.png){#fig:002}

И напишем код второй программы в файле script2.sh  (рис. [-@fig:003]).

![Код второй программы](image/3.png){#fig:003}

Напишем код третьей программы в файле script3.sh (рис. [-@fig:004]).

![Код третьей программы](image/4.png){#fig:004}

Напишем код четвёртой программы в файле script4.sh (рис. [-@fig:005]).

![Код четвёртой программы](image/5.png){#fig:005}
