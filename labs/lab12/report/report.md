...
Напишем код второй программы (рис. [-@fig:002]).

![Код второй программы](image/2.png){#fig:002}

Напишем код третьей программы (рис. [-@fig:003]).

![Код третьей программы](image/3.png){#fig:003}

Напишем код четвёртой программы (рис. [-@fig:004]).

![Код четвёртой программы](image/4.png){#fig:004}
